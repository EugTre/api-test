"""Unit tests for FastJsonWrapper

pytest -s -vv ./utils/json_content/test_fast_json_wrapper.py
"""
import copy
...
def get_wrapper() -> FastJsonWrapper:
    """Returns instance of FastJsonWrapper class with copied content"""
    return FastJsonWrapper(copy.deepcopy(TestData.CONTENT))
...
def get_array_wrapper() -> FastJsonWrapper:
    """Returns instance of FastJsonWrapper class with copied content"""
    return FastJsonWrapper(copy.deepcopy(ArrayTestData.CONTENT))
...
# --- Test data
class TestData:
    """Test data for FastJsonWrapper (dict) tests"""
    CONTENT = {
            "a": {
                "b1": 100,
                "b2": [1,2,3],
...
class ArrayTestData:
    """Test data for array-based FastJsonWrapper"""
    CONTENT = [
        {'id': 1, 'enabled': True},
...
# --- Tests (dict content)
class TestFastJsonWrapperGet:
    """Tests FastJsonWrapper .get() method using JSON dict object"""
    # --- Positive tests
    ...
    def test_get_by_key_pointer(
        self, wrapper: FastJsonWrapper, pointer: str, expected: Any):
    ...
    def test_has_on_existing_key(self,
        wrapper: FastJsonWrapper, pointer: str):
    ...
    def test_get_or_default_exists_returns_value(
        self, wrapper: FastJsonWrapper, pointer: str):
    ...
    def test_equals(self):
        ...
        wrapper1 = FastJsonWrapper(copy.deepcopy(TestData.CONTENT))
        wrapper2 = FastJsonWrapper(copy.deepcopy(TestData.CONTENT))
    ...
    def test_check_exists_by_in(self, pointer: str):
        """Wrappers with different contents not equals"""
        wrapper = FastJsonWrapper(copy.deepcopy(TestData.CONTENT))
    ...
    def test_get_by_invalid_pointer_fails(
        self, wrapper: FastJsonWrapper, ptr: str):
...
class TestFastJsonWrapperUpdate:
    """Tests FastJsonWrapper .update() method using JSON dict object"""
    ...
    def test_update_by_key_pointer(
        self, wrapper: FastJsonWrapper, content: dict,
    ...
    def test_update_append_index_pointer(
        self, wrapper: FastJsonWrapper, content):
    ...
    def test_update_by_oob_index_fails(self, wrapper: FastJsonWrapper):
    ...
    def test_update_by_oob_node_index_fails(self, wrapper: FastJsonWrapper, ptr: str):
        """Update using pointer to valid list node, but index is out of bounds
        should fail with exception"""
        with pytest.raises(KeyError,
                           match=KEY_ERROR_MSG_ON_FAIL_TO_FIND):
...
class TestFastJsonWrapperDelete:
    """Tests FastJsonWrapper .delete() method using JSON dict object"""
    # --- Positive tests
    @pytest.mark.parametrize("ptr, delete_path", [
        ('/a/b1', "['a']['b1']"),
        ('/c', "['c']")
    ])
    def test_delete_by_key(self, wrapper: FastJsonWrapper, content: dict,
    ...
    def test_delete_by_index(self, wrapper: FastJsonWrapper, content: dict,
                                                   ptr: str, delete_path: str):
    ...
    def test_delete_all(self, wrapper: FastJsonWrapper):
    ...
    def test_delete_missing_pointer_fails_silently(
        self, wrapper: FastJsonWrapper, content: dict, ptr: str):
...
class TestFastJsonWrapperIterate:
    """Tests FastJsonWrapper .__iter__() method using JSON dict object"""
    def test_iterate(self):
        ...
        wrapper = FastJsonWrapper(content)
...
# --- Tests (array content)
class TestFastJsonWrapperArrayGet:
    """Tests .get() method of FastJsonWrapper object based on JSON array"""
    # --- Positive tests
    def test_array_get_entire_content(
        self, array_wrapper: FastJsonWrapper):
    ...
    def test_array_get_by_index(
        self, array_wrapper: FastJsonWrapper, ptr: str, expected: Any):
...
class TestFastJsonWrapperArrayUpdate:
    """Tests .update() method of FastJsonWrapper object based on JSON array"""
...
class TestFastJsonWrapperArrayDelete:
    """Tests .delete() method of FastJsonWrapper object based on JSON array"""
...
class TestFastJsonWrapperArrayIterate:
    """Tests FastJsonWrapper .__iter__() method using JSON wrapper based on JSON array"""
    def test_iterate(self):
        """Iteration return all entities"""
        content = [
            1,
